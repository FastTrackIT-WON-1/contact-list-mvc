...
{
    public interface IContactListEntryService
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns true if the entry with the specified id exists, false otherwise.
        /// </summary>
        /// <param name="id">The contact list identifier.</param>
        /// <returns>True if the entry with the specified id exists, false otherwise.</returns>
